...
export const SetupGuide: React.FC = () => {
  return (
    <div className="bg-slate-900 border border-rose-900/50 rounded-xl overflow-hidden shadow-2xl max-w-lg w-full animate-fade-in">
        ...
        <ol className="space-y-3">
          ...
          <li className="flex gap-3 items-start bg-slate-800/50 p-3 rounded-lg border border-slate-700">
            ...
            <div className="text-sm text-slate-400">
              ...
              Ve a <span className="text-slate-200">Settings</span> → <span className="text-slate-200">Environment Variables